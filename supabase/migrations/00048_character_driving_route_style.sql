-- Per-character routing persona: feeds Google Routes modifiers, pin-selection
-- thresholds, and viewer-facing badges on the live map.

ALTER TABLE characters
  ADD COLUMN IF NOT EXISTS driving_route_style JSONB NOT NULL DEFAULT jsonb_build_object(
    'version', 1,
...
COMMENT ON COLUMN characters.driving_route_style IS
  'Driver routing persona (comfort vs speed, smooth vs direct, eco). Used by destination-route, driver-route planning, and viewer map chips.';
